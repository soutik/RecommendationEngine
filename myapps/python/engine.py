...
class RecommendationEngine:
    ...
    def __count_and_average_ratings(self):
        ...
        self.movies_rating_counts_RDD = movie_ID_with_avg_ratings_RDD
    ...
    def __predict_ratings(self, user_and_movie_RDD):
        ...
        predicted_rating_title_and_count_RDD = \
            predicted_rating_RDD.join(self.movies_titles_RDD.map(lambda x: (int(x[0]), x[1]))).join(self.movies_rating_counts_RDD.map(lambda x: (int(x[0]), x[1])))
        predicted_rating_title_and_count_RDD = \
